...
export default function Login() {
  ...
  return (
    ...
    >
      <div className="w-[50%] h-screen hidden lg:block left-0 relative">
        <Image src={bgImage} alt="bg-image" className="h-screen  object-rigth object-cover" />
        <TextContainer text="Bem-vindo ao learnUp a plataforma de aprendizagem definitiva para ajudá-lo a alcançar o seu potencial máximo nos estudos!" highlightedWord="learnUp" />
      </div>
