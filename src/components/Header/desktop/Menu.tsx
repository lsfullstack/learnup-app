...
const Menu = () => {
  const { menuIsOpen } = useContext(LearnUpContext);
  ...
  return (
    ...
    >
      ...
      <Link href="/login" className="w-full border-b-2 border-grey-5 px-4 py-2 font-enphasis text-grey-3 hover:underline" >Sair</Link>
    </nav>
  )
}
